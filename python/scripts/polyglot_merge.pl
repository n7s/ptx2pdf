...
my $usage="\nUsage: $0 [-mode|options]  File1 File2 File3\n"
	...
	. "-S 60,45,45,10\t Use an uneven scoring for each file. A potential break-point becomes a real (forced) break-point if the total score is 100 or or. This example will force a break any time the first column has a break that coincides with one in the second or third column, or if any three columns agree.columns.\n"
